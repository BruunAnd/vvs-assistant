...
namespace VVSAssistant.Functions.Calculation
{
    static class EEICharLabelChooser
    {
        ...
        static public string EEIChar(ApplianceTypes PrimaryHeat, float CalcEII)
        {
            switch (PrimaryHeat)
            {
                ...
                case ApplianceTypes.CHP:
                    return Labels[getLabel(PrimPumpOrBoilOrCHP, CalcEII)];
                case ApplianceTypes.LowTempHeatPump:
                    return Labels[getLabel(LowHeatPump, CalcEII)];
                default:
                    return null;
            }
        ...
        static public string EEIChar(UseProfileType TypeOfUser, float CalcEEI)
        {
            switch (TypeOfUser)
            {
                case UseProfileType.M:
                    return Labels[getLabel(UserTypeM, CalcEEI)];
                case UseProfileType.L:
                    return Labels[getLabel(UserTypeL, CalcEEI)];
                case UseProfileType.XL:
                    return Labels[getLabel(UserTypeXL, CalcEEI)];
                case UseProfileType.XXL:
                    return Labels[getLabel(UserTypeXXL, CalcEEI)];
                default:
                    return null;
            }
        ...
        static private int getLabel(List<float> correctType, float EEI)
        {
